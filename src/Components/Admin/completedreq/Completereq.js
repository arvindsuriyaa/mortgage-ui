...
export default function Completereq() {
  ...
  const steps = ["Document Verification", "Underwriting", "Approved"];
  ...
  let updatestatus = (index, loanId) => {
    ...
    let statusType = steps[newupdatestatus[index] - 2];
  ...
  return (
    ...
    <div className="admin_content">
      ...
      <div className="admin_loan_container">
        <div className="row">
          {loan.map((obj, index) => {
            if (obj.currentstatus == "Background Checks") {
              // loanFound = true;
              let creditScore = "";
              let interest = "";
                    ...
                    <CardActions>
                      ...
                      >
                        ...
                        >
                          ...
                          {steps.map((item, i) => {
                            return <MenuItem value={i + 2}>{item}</MenuItem>;
                          })}
                        </Select>
                      </FormControl>
                      <Button
