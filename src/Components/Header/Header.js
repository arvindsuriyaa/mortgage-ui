    ...
    return (
      <div className="header_head">
        ...
        <div className="menu">
          ...
          <NavLink to="/aboutus" activeclassname="active" exact="true">
            About Us
          </NavLink>
          {/* <NavLink to="/ourproducts" activeclassname="active" exact="true">Our Products</NavLink> */}
          <NavLink to="/emicalculator" activeclassname="active" exact="true">
            EMI Calculator
          </NavLink>
          <NavLink to="/enquire" activeclassname="active" exact="true">
            Enquire
          </NavLink>
